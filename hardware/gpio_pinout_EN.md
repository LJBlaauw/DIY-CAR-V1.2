...
| GPIO26 | IN (ADC0) | LDR A | J8 (JST-XH 2) — net `Net-(J8-Pin_1)` | Pull-up R29 (10 kΩ) to 3V3; filter C13 |
| GPIO27 | IN (ADC1) | LDR B | J9 (JST-XH 2) — net `Net-(J9-Pin_1)` | Pull-up R30 (10 kΩ) to 3v3; filter C15 |
