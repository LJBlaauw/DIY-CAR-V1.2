...
# --- Test script: GY9250 fusion (complementary filter with tilt compensation) on OLED ---
...
ak8963 = AK8963(
    i2c_sensor,
    offset=(-24.5, 12.3, -5.1),      # ENTER YOUR CALIBRATION VALUES HERE (see test_gy9250_calibrate.py)
...
toon(["GY9250 fusion test", "Sensor found", "start in 2s..."])
print("GY9250 fusion test: sensor found, whoami=" + hex(sensor.whoami))
time.sleep(2)
...
try:
    while True:
        ...
        time.sleep_ms(5)  # approx. 200 Hz
except KeyboardInterrupt:
    toon(["GY9250 fusion test", "Stopped."])
    print("Test stopped.")
