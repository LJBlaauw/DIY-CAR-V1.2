...
# --- Test script: GY9250 basic (complementary filter) with live display on OLED ---
...
toon(["GY9250 basic test", "Sensor found", "start in 2s..."])
print("GY9250 basic test: sensor found, whoami=" + hex(sensor.whoami))
time.sleep(2)
...
try:
    ...
    toon(["GY9250 basic test", "Stopped."])
    print("Test stopped.")
